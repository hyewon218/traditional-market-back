...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public static final String FIRST_REDIRECT_PATH = "http://tmarket.kro.kr/add-info"; // 추가정보 입력 페이지
    ...
    public static final String REDIRECT_PATH = "http://tmarket.kro.kr/market"; // 홈
