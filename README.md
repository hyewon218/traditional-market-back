...
[https://tmarket.store](https://tmarket.store)
...
## 📢 프로젝트 소개
소비자들이 직접 시장을 방문하지 않고도 다양한 점포의 상품 가격을 실시간으로 비교할 수 있습니다. 
현재는 상품 가격 정보 제공에 중점을 두고 있으며 추후 배달 서비스까지 확장하여 전통시장의 디지털 경쟁력을 강화하고자 합니다.

## ⁉️ 기획 의도
이 프로젝트를 기획하게 된 계기는 전통시장의 특성상 여러 점포에서 동일한 품목을 판매하고 있어 소비자들이 각 점포의 가격을 일일이 확인해야 하는 불편함을 겪는다는 점에 주목했기 때문입니다. 이러한 문제를 해결하기 위해 온라인 플랫폼을 통해 가격 정보를 투명하게 제공함으로써 소비자들의 합리적인 구매 결정을 돕고 전통시장의 현대화에 기여하고자 했습니다.
